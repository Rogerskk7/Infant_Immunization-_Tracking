...
<a href="staffhome.php" style="font-size: 30px; background-color:purple; color: white;">HOME</a><br>
    ...
    require 'connection.php';
    $car = $_POST['car'];
    $result5 = mysqli_query($con, "SELECT * FROM cars WHERE name LIKE '%{$car}%'");
       if (mysqli_num_rows($result5)==0) {
      # code...
      echo '<h3 style="background-color: green;color: white;">Such Car was not found.</h3>';
    } 
    ...
    echo ' <div class="col-md-3 col-xs-5" style="border-radius:10px; background-color:pink; margin-right:10px;">
                ...
                <center> <a href="delete.php?id='.$row['number'].'"><button>Delete</button></a></center>
            </div>';
    }      
